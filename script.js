...
var Clock = (function() {
    var canvas,
        ...
        press = false, 
        quiver = true, 
        texts = ["蔚蓝星空下","男孩独自坐望","星海闪烁","仿佛在问","为什么你一个人","我在等一个人","一个女孩","这个女孩","她的名字是....."],
    ...
    function getBasePath() {
        ...
        if (currentPath.includes('/helen-max-love/')) {
            return '/helen-max-love/Rom/';
        }
        return './';
    }
        ...
        event: function() {
            ...
            document.addEventListener('click', function() {
                if (textNum < texts.length - 1) {
                    ...
                    const basePath = window.location.pathname.includes('/helen-max-love/') ? '/helen-max-love/' : '';
